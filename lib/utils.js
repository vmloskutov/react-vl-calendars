...
var googleShareUrl = function googleShareUrl(_ref) {
  var description = _ref.description,
      ...
      title = _ref.title,
      recur = _ref.recur;
  return "https://calendar.google.com/calendar/render?action=TEMPLATE&dates=".concat(startDatetime, "/").concat(endDatetime).concat(timezone && "&ctz=".concat(timezone), "&location=").concat(location, "&text=").concat(title, "&details=").concat(description, "&recur=").concat(recur);
};
/**
...
var buildShareFile = function buildShareFile(_ref3) {
  var _ref3$description = _ref3.description,
      ...
      _ref3$recur = _ref3.recur,
      recur = _ref3$recur === void 0 ? '' : _ref3$recur;
...
var buildShareUrl = function buildShareUrl(_ref4, type) {
  var _ref4$description = _ref4.description,
      ...
      _ref4$recur = _ref4.recur,
      recur = _ref4$recur === void 0 ? '' : _ref4$recur;
